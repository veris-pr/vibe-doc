...
export function EditorView({
  ...
  }, [onSave, onFormatBold, onFormatItalic]);
  ...
  return (
    <div class="editor-container">
      <div class="editor-toolbar">
        <div class="toolbar-left">
          ...
          <input
            ...
            class="path-input"
          />
          {hasUnsavedChanges && <span class="unsaved-dot" title="Unsaved changes" />}
        </div>
        
        <div class="toolbar-center">
          <button onClick={() => onInsertHeading(1)} title="Heading 1">H1</button>
          <button onClick={() => onInsertHeading(2)} title="Heading 2">H2</button>
          <button onClick={() => onInsertHeading(3)} title="Heading 3">H3</button>
          <span class="toolbar-divider" />
          <button onClick={onInsertCodeBlock} title="Code block">{ }</button>
          <button onClick={onInsertCallout} title="Callout">💬</button>
          <button onClick={onInsertLink} title="Link">🔗</button>
          <span class="toolbar-divider" />
          <button onClick={onFormatBold} title="Bold (Cmd+B)"><strong>B</strong></button>
          <button onClick={onFormatItalic} title="Italic (Cmd+I)"><em>I</em></button>
        </div>
        
        <div class="toolbar-right">
          <button onClick={onTogglePreview} class={showPreview ? 'active' : ''}>
            {showPreview ? 'Hide' : 'Show'} Preview
          </button>
          <button onClick={onSave} disabled={!canSave} class="save-btn">
          ...
          <div class="editor-sidebar">
            ...
            <div class="sidebar-section">
              ...
              <ul class="component-list">
                <li onClick={onInsertCodeBlock}>Code Block</li>
                <li onClick={onInsertCallout}>Callout</li>
                <li onClick={onInsertLink}>Link</li>
              </ul>
            </div>
          </div>
        )}
      ...
      <style>{`
        ...
        .file-list li { font-family: var(--font-mono); }
        ...
        .component-list li { font-family: var(--font-sans); }
